class DealerFormsController < ApplicationController
    ...
    def create
        ...
        @dealer_form = DealerForm.new(params.require(:dealer_form).permit(:badge_name, :business_name, :type_of_merchandise_or_service, :company_website_address, :number_of_spaces, :display_require_AC_power, :number_of_memberships, :name_and_age_of_members))
    ...
    def update
        ...
        if @dealer_form.update(params.require(:dealer_form).permit(:badge_name, :business_name, :type_of_merchandise_or_service, :company_website_address, :number_of_spaces, :display_require_AC_power, :number_of_memberships, :name_and_age_of_members, :approved))
