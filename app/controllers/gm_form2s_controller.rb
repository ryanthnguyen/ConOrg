class GmForm2sController < ApplicationController
    ...
    def create
        ...
        @gm_form2 = GmForm2.new(params.require(:gm_form2).permit(:age_restriction, :game_attitude, :game_description, :game_system_used, :info_for_staff, :materials_needed, :minimum_of_players, :maximum_of_players, :player_experience, :start_time_first_choice, :start_time_second_choice, :start_time_third_choice, :time_needed_for_game, :title_of_adventure_or_session, :type_of_game))
    ...
    def update
        ...
        if @gm_form2.update(params.require(:gm_form2).permit(:age_restriction, :game_attitude, :game_description, :game_system_used, :info_for_staff, :materials_needed, :minimum_of_players, :maximum_of_players, :player_experience, :start_time_first_choice, :start_time_second_choice, :start_time_third_choice, :time_needed_for_game, :title_of_adventure_or_session, :type_of_game, :approved))
