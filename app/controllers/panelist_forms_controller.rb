class PanelistFormsController < ApplicationController
    ...
    def new
        begin
            @user = PanelistForm.find(params[:user_id])
        rescue
